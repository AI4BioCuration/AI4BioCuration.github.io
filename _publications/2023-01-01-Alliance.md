...
citation: "Bult, C.J. et al., 2023. The Alliance of Genome Resources: building a modern data ecosystem for model organism databases. Genetics.":contentReference[oaicite:2]{index=2}
keywords:
